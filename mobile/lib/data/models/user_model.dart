...
class UserModel {
  ...
  static PlayerLevel? _parseLevel(String? l) {
    switch (l) {
      case 'beginner':     return PlayerLevel.beginner;
      case 'intermediate': return PlayerLevel.intermediate;
      case 'advanced':     return PlayerLevel.advanced;
      default:             return null;
    }
  }
  ...
  static UserRole _parseRole(String r) {
    switch (r) {
      case 'court_admin':  return UserRole.courtAdmin;
